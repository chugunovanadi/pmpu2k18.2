...
public class Library {
    ...
    // книга, которая есть в бибилиотеке
    ...
    private void borrowBook(String title) {
        if (findBook(title) != null) {
            if (!findBook(title).isBorrowed()) {
                ...
                System.out.println("Книгу уже кто-то взял");
            }

        } else {
            System.out.println("Такой книги нет в каталоге библиотеки");
        }
    ...
    private void printAvailableBooks() {
        if (books.size() != 0) {
            ...
            System.out.println("В каталоге пусто");
        }
    }
