...
def dividing_window_by_markets(transactions, market_list,
    ...
    for market in market_list:
        ...
        division.append([market, trans_time,
                         num_transactions, sum_transactions])
    return division
...
def longest_window_by_market(transactions, market):
    transactions_by_market = dividing_transactions_by_market(transactions,
                                                             market)
