...
class Tester(TestCase):
    ...
    def test_true_decrypt_1(self):
        self.assertEqual(decrypt(3, 'Khoor zruog'),
                         'Hello world')

    def test_true_decrypt_2(self):
        self.assertEqual(decrypt(-5, 'Hjtp fjipn q qviijt'),
                         'Moyu konus v vannoy')

    def test_true_decrypt_3(self):
        self.assertEqual(decrypt(25, 'Uxkhuzxt uhmn u qzjnuhmt'),
                         'Vylivayu vino v rakovinu')
    ...
    def test_true_decrypt_6(self):
        self.assertEqual(decrypt(7, 'WvZaHcaL ghjola HCAVTHAVT'),
                         'PoStAvtE zachet AVTOMATOM')

    def test_true_decrypt_7(self):
        self.assertEqual(decrypt(5, 'BDCEEEEEbdceeeeeee'),
                         'WYXZZZZZwyxzzzzzzz')

    def test_exception_encrypt(self):
        self.assertRaises(Exception, encrypt, 26, "Hello")
