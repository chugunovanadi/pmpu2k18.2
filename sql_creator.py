...
"""
Скрипт для создания и копирования базы данных.
...
def create_sql(db_name):
    sql_con = sqlite3.connect(db_name)  # Устанавливается соединение с базой
    cursor = sql_con.cursor()

    # создаем таблицу с названием 'user_choice' в нашей базе данных, объявляя какие должны быть поля.
    ...
    # group data
    # Далее остальные таблицы в бд создаем по аналогии:
...
# метод для копирования базы данных (не обязателен)
